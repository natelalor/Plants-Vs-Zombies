...
class Game(arcade.View):
    def __init__(self, level: int, window, defenders_ids):
        ...
        plant1_button = arcade.gui.UITextureButton(texture=arcade.load_texture('images/sunflower.png'),
                                                   texture_hovered=arcade.load_texture('images/sunflowerHover.png'),
                                                   texture_pressed=arcade.load_texture('images/sunflowerSelected.png'),
                                                   width=75, height=75)
        self.h_box.add(arcade.gui.UIBorder(plant1_button.with_border(color=(117, 35, 19, 255)), border_width=10,
                                           border_color=(117, 35, 19, 255)))

        plant2_button = arcade.gui.UITextureButton(texture=arcade.load_texture('images/peaShooter.png'),
                                                   texture_hovered=arcade.load_texture('images/peaShooterHover.png'),
                                                   texture_pressed=arcade.load_texture('images/peaShooterSelected.png'),
                                                   width=75, height=75)
        self.h_box.add(arcade.gui.UIBorder(plant2_button.with_border(color=(117, 35, 19, 255)), border_width=10,
                                           border_color=(117, 35, 19, 255)))

        plant3_button = arcade.gui.UITextureButton(texture=arcade.load_texture('images/peaShooter.png'),
                                                   texture_hovered=arcade.load_texture('images/peaShooterHover.png'),
                                                   texture_pressed=arcade.load_texture('images/peaShooterSelected.png'),
                                                   width=75, height=75)
        self.h_box.add(arcade.gui.UIBorder(plant3_button.with_border(color=(117, 35, 19, 255)), border_width=10,
                                           border_color=(117, 35, 19, 255)))

        plant4_button = arcade.gui.UITextureButton(texture=arcade.load_texture('images/peaShooter.png'),
                                                   texture_hovered=arcade.load_texture('images/peaShooterHover.png'),
                                                   texture_pressed=arcade.load_texture('images/peaShooterSelected.png'),
                                                   width=75, height=75)
        self.h_box.add(arcade.gui.UIBorder(plant4_button.with_border(color=(117, 35, 19, 255)), border_width=10,
                                           border_color=(117, 35, 19, 255)))

        plant5_button = arcade.gui.UITextureButton(texture=arcade.load_texture('images/peaShooter.png'),
                                                   texture_hovered=arcade.load_texture('images/peaShooterHover.png'),
                                                   texture_pressed=arcade.load_texture('images/peaShooterSelected.png'),
                                                   width=75, height=75)
        self.h_box.add(arcade.gui.UIBorder(plant5_button.with_border(color=(117, 35, 19, 255)), border_width=10,
                                           border_color=(117, 35, 19, 255)))

        shovel_button = arcade.gui.UITextureButton(texture=arcade.load_texture('images/shovel.png'),
                                                   texture_hovered=arcade.load_texture('images/shovel.png'),
                                                   texture_pressed=arcade.load_texture('images/shovel.png'), width=75,
                                                   height=75)
    ...
    def on_draw(self):
        ...
        if (self.currency >= 300):
            ...
            if (self.plant5_selected):
                ...
                arcade.draw_rectangle_outline(center_x=445, center_y=581, color=(154, 205, 50, 255), width=76,
        ...
        if (self.currency >= 200):
            ...
            if (self.plant4_selected):
                ...
                arcade.draw_rectangle_outline(center_x=346, center_y=581, color=(154, 205, 50, 255), width=76,
                                              height=76, border_width=5)
                arcade.draw_text(str(200), 323.5, 535, arcade.color.ALICE_BLUE, 20, 40, 'center')
        else:
        ...
        if (self.currency >= 150):
            ...
            if (self.plant3_selected):
                ...
                arcade.draw_rectangle_outline(center_x=247, center_y=581, color=(154, 205, 50, 255), width=76,
                                              height=76, border_width=5)
                arcade.draw_text(str(150), 223.5, 535, arcade.color.ALICE_BLUE, 20, 40, 'center')
        ...
        if (self.currency >= 100):
            ...
            if (self.plant2_selected):
                ...
                arcade.draw_rectangle_outline(center_x=150, center_y=581, color=(154, 205, 50, 255), width=76,
                                              height=76, border_width=5)
                arcade.draw_text(str(100), 123.5, 535, arcade.color.ALICE_BLUE, 20, 40, 'center')
        else:
        ...
        if (self.currency >= 50):
            ...
            if (self.plant1_selected):
                ...
                arcade.draw_rectangle_outline(center_x=50, center_y=581, color=(245, 245, 0), width=76, height=76,
                                              border_width=5)
                arcade.draw_text(str(50), 23.5, 535, arcade.color.ALICE_BLUE, 20, 40, 'center')
        else:
